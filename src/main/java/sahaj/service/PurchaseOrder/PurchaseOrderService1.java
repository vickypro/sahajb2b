...
public class PurchaseOrderService1 {
	...
	public void SavepoContract(PurchaseOrder poContract, List<Table> table, List<TableContent> exp_table,List<TableContent2> exp_table2)
	{
		...
		for(Table tab:table)
		{
			...
			docBuilder.append("Exp_receive",tab.getReceive());
		}
	...
	public void Pdfdata(String pdfFileInText,Table tab,List<Table> table)
	{
        ...
        String intendarr[] = pdfFileInText.split("Indent No. :");
...
////////////////////////////Dates//////////////////////////////////////////////////////
        ...
        tab.setDate(datess);
//////////////////////////////////////Address//////////////////////////////////////////////////
        String addressarr[] = pdfFileInText.split("Place of Magazine  :");
...
////////////////////////////////////valid date///////////////////////////////////////////////////
        String validarr[] = pdfFileInText.split("valid till");
...
///////////////////////////////////////license////////////////////////////////////////////                
        String licarr[] = pdfFileInText.split("licence number");
