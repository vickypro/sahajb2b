(function() {
  ...
  angular.module('sahajApp.components.gmap')
  ...
  function snGmap($rootScope, $timeout, jQuery, $window){
    ...
    if (!angular.isDefined($window.GMaps)){
      ...
      script.src = 'http://maps.google.com/maps/api/js?key=key=AIzaSyD50GdjI4FhUFwaugpc8GdvfBMb7haqWEQ&sensor=true&callback=googleMapsLoaded';
